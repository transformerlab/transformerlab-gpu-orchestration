...
export const FakeDataProvider: React.FC<FakeDataProviderProps> = ({ children }) => {
  ...
  return (
    <FakeDataContext.Provider value={{ showFakeData, setShowFakeData: handleSetShowFakeData }}>
      {children}
