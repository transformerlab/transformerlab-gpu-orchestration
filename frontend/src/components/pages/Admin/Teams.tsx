                  ...
                  {isAdmin ? (
                    ...
                    >
                      ...
                      <IconButton
                        ...
                        color="danger"
                        onClick={() =>
                          openDeleteTeam({ id: team.id, name: team.name })
                        }
                        title="Delete team"
                      >
                        <Trash2 size={14} />
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Stack spacing={1}>
              {authLoading || loading ? (
                ...
                (teams.find((t) => t.id === selectedTeamId)?.members || []).map(
                  (member) => (
                        ...
                        >
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              ...
                              // Snapshot previous state for rollback
                              const prevTeam = teams.find(
                                (t) => t.id === teamId,
                              );
                              const prevMembers = prevTeam
                                ? [...prevTeam.members]
                                : [];
                              const prevAllUsers = [...allUsers];
        ...
        <ModalDialog>
          ...
          <DialogContent>
            <Typography>
              ...
              from <strong>{selectedTeamName}</strong>?
            </Typography>
          </DialogContent>
          <DialogActions>
            <Button
