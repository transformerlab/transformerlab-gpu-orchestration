...
class OrganizationResponse(BaseModel):
    ...
    object: Optional[StrictStr] = 'organization'
    __properties: ClassVar[List[str]] = ["id", "name", "domains", "object"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "object": obj.get("object") if obj.get("object") is not None else 'organization'
        })
        return _obj
