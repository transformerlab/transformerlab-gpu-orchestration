...
class OrganizationsResponse(BaseModel):
    ...
    current_organization_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["organizations", "current_organization_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if current_organization_id (nullable) is None
        # and model_fields_set contains the field
        if self.current_organization_id is None and "current_organization_id" in self.model_fields_set:
            _dict['current_organization_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_organization_id": obj.get("current_organization_id")
        })
        return _obj
