...
class CreateStorageBucketRequest(BaseModel):
    ...
    persistent: Optional[StrictBool] = True
    mode: Optional[StrictStr] = 'MOUNT'
    __properties: ClassVar[List[str]] = ["name", "remote_path", "source", "store", "persistent", "mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "store": obj.get("store"),
            "persistent": obj.get("persistent") if obj.get("persistent") is not None else True,
            "mode": obj.get("mode") if obj.get("mode") is not None else 'MOUNT'
        })
        return _obj
