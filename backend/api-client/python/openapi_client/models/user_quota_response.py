...
class UserQuotaResponse(BaseModel):
    ...
    custom_quota: StrictBool
    created_at: StrictStr
    updated_at: StrictStr
    __properties: ClassVar[List[str]] = ["user_id", "user_email", "user_name", "organization_id", "monthly_gpu_hours_per_user", "custom_quota", "created_at", "updated_at"]
