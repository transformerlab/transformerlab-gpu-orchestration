...
class JobRecord(BaseModel):
    ...
    job_name: StrictStr
    username: StrictStr
    submitted_at: Union[StrictFloat, StrictInt]
    start_at: Optional[Union[StrictFloat, StrictInt]] = None
    end_at: Optional[Union[StrictFloat, StrictInt]] = None
    resources: StrictStr
    status: StrictStr
    log_path: StrictStr
    __properties: ClassVar[List[str]] = ["job_id", "job_name", "username", "submitted_at", "start_at", "end_at", "resources", "status", "log_path"]
