...
from db_models import TeamQuota, Team
...
from lattice.routes.auth.utils import check_organization_admin, check_organization_member
...
async def update_team_quota_endpoint(
    ...
    team_quota = create_or_update_team_quota(
        ...
        organization_id, 
        team_id, 
        quota_request.monthly_gpu_hours_per_user
    )
