...
class SSHKeyListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ssh_keys", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ssh_keys": [SSHKeyResponse.from_dict(_item) for _item in obj["ssh_keys"]] if obj.get("ssh_keys") is not None else None,
