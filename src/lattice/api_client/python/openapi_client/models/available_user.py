...
class AvailableUser(BaseModel):
    ...
    has_team: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["user_id", "email", "first_name", "last_name", "profile_picture_url", "has_team"]
