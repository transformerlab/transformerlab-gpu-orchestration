...
class AzureTestRequest(BaseModel):
    ...
    auth_mode: Optional[StrictStr] = 'service_principal'
    __properties: ClassVar[List[str]] = ["subscription_id", "tenant_id", "client_id", "client_secret", "auth_mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenant_id": obj.get("tenant_id") if obj.get("tenant_id") is not None else '',
            ...
            "auth_mode": obj.get("auth_mode") if obj.get("auth_mode") is not None else 'service_principal'
        })
        return _obj
